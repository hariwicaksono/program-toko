                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="<?= base_url('kasir/transaksi') ?>">
                        ...
                        <span class="smini-hide">
                            <span class="font-w700 font-size-h5">UD.MATAHARI</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content py-3">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                            Created with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="">IT SHOP Pwt</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="">IT SHOP Pwt</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>

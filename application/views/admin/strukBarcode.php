...
<html lang="en">
  ...
  <body>
    <h1 class="text-center" style="font-size:60px;"><a href="<?= base_url('transaksi/backFromStruk') ?>">UD.MATAHARI</a></h1>
    <h3 class="text-center">Dukuhwaluh, Kec. Kembaran, Kab. Banyumas</h3>
    <h3 class="text-center">Telp. 0812 3456 7890</h3>
    <!-- <h5>==================================================================================</h5> -->
